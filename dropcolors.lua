...
local text=[=[
In this chart, I'm giving the Krakenstein a 12 HP/S rate of healing - half of the normal Medigun's base rate of 24. However, while the Medigun begins its ramp up after 10 seconds without taking damage, the Krakenstein starts ramping up its healing after only 4 seconds. With a multiplier of 4 times the base rate over 8 seconds, the Krakenstein heals more health in the window between 6 to 13 seconds after taking damage than the normal medigun (which rises to triple the base rate over 5 seconds). Numbers numbers numbers
]=]
